...
const useOptionsHooks = () => {
    ...
    const handleMoveFolder = async (folderId: string, schemaId: string, callback: (type: errorType, data: any) => void) => {
        try {
    ...
    const moveTofolders = (folderId: string, schemaId: string, callback: (type: errorType, data: any) => void) => {
