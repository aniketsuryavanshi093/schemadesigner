...
const AccordionBodyColumn: React.FC<{ table: Table, column: columns, isFocused: number, tableIndex: string }> = ({ table, column, isFocused, tableIndex }) => {
    ...
    return (
        <div className='flex flex-[3] mb-2 items-center justify-center gap-2 '>
            ...
            <PopoverComponent popoverOpen={open} setPopover={setopen} classname="px-2 py-2 columtypewrapper" placement='right-end' content={<ColumnTypeSelector column={column} table={table} close = {()=>setopen(false)}/>} trigger={
